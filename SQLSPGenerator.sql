...
DECLARE @DBName nvarchar(100)=N'bcaprio_custom';
DECLARE @DBRoleName nvarchar(100)=N'db_owner';
DECLARE @TableName nvarchar(100)=N'UserIdentity';
DECLARE @ViewName nvarchar(100)=N'UserIdentity';
DECLARE @ProcName nvarchar(100)=N'SP_' + @TableName + 'Model';
DECLARE @OrderBy nvarchar(100)=N'ID';
DECLARE @OrderByDir nvarchar(4)=N'ASC';
DECLARE @AUTHOR nvarchar(50) ='MSI';
DECLARE @DESC nvarchar(100) ='BCAPrio CRUD Procedure'; -- Ex. 'User Data' will return 'Description : Upsert User Data'
...
--Print Upsert Statement
    PRINT N'/****** Object:  StoredProcedure [dbo].[' + @ProcName + 'Update]    Script Date: ' + CAST(GETDATE() AS nvarchar(30)) + '  ******/' + CHAR(13) + CHAR(10) 
    PRINT @LEGEND;
    PRINT N'-- Description : Upsert ' + @DESC + CHAR(13) + CHAR(10) 
    PRINT N'-- ===================================================================' + CHAR(13) + CHAR(10) 
    PRINT CHAR(13) + CHAR(10) 
    PRINT N'CREATE PROCEDURE [dbo].[' + @ProcName  + 'Update]' + CHAR(13) + CHAR(10);
    ...
    PRINT N'  IF @ID IS NULL' + CHAR(13) + CHAR(10) 
    PRINT N'    BEGIN' + CHAR(13) + CHAR(10) 
...
----Now add GRANT and DENY permissions to the Role
    --PRINT N'GRANT EXECUTE ON [dbo].[' + @ProcName + 'Update] TO [' + @DBRoleName + ']' + CHAR(13) + CHAR(10) 
    --PRINT N'GO' + CHAR(13) + CHAR(10) 
    --PRINT N'DENY VIEW DEFINITION ON [dbo].[' + @ProcName + 'Update] TO [' + @DBRoleName + ']' + CHAR(13) + CHAR(10) 
    --PRINT N'GO' + CHAR(13) + CHAR(10) 
    --PRINT CHAR(13) + CHAR(10) 
    --PRINT CHAR(13) + CHAR(10) 

    --Print Select Statement
    PRINT N'/****** Object:  StoredProcedure [dbo].[' + @ProcName + 'Get]    Script Date: ' + CAST(GETDATE() AS nvarchar(30)) + '  ******/' + CHAR(13) + CHAR(10) 
    PRINT @LEGEND;
    PRINT N'-- Description : Select ' + @DESC + CHAR(13) + CHAR(10) 
    PRINT N'-- ===================================================================' + CHAR(13) + CHAR(10) 
    PRINT CHAR(13) + CHAR(10) 
    PRINT N'CREATE PROCEDURE [dbo].[' + @ProcName  + 'Get]' + CHAR(13) + CHAR(10);
    PRINT N'  (@ID uniqueidentifier=NULL' + IIF(@ISACTIVE_SEL = 1,', @IsActive bit=NULL','') + ')' + CHAR(13) + CHAR(10);
    PRINT N'AS' + CHAR(13) + CHAR(10) 
    PRINT N'BEGIN' + CHAR(13) + CHAR(10) 
    --PRINT N'  SET CONTEXT_INFO @MyID;' + CHAR(13) + CHAR(10) 
    ...
    PRINT N'  ELSE' + CHAR(13) + CHAR(10) 
    PRINT N'    SELECT * FROM [dbo].[' + @ViewName + '] WHERE [ID] = @ID;' + CHAR(13) + CHAR(10) 
    PRINT N'  SET NOCOUNT OFF;'+ CHAR(13) + CHAR(10) 
    PRINT N'END' + CHAR(13) + CHAR(10) 
    PRINT N'GO' + CHAR(13) + CHAR(10) 
    PRINT CHAR(13) + CHAR(10) 

----Now add GRANT and DENY permissions to the Role
    --PRINT N'GRANT EXECUTE ON [dbo].[' + @ProcName + 'Get] TO [' + @DBRoleName + ']' + CHAR(13) + CHAR(10) 
    --PRINT N'GO' + CHAR(13) + CHAR(10) 
    --PRINT N'DENY VIEW DEFINITION ON [dbo].[' + @ProcName +'Get] TO [' + @DBRoleName + ']' + CHAR(13) + CHAR(10) 
    --PRINT N'GO' + CHAR(13) + CHAR(10) 
    --PRINT CHAR(13) + CHAR(10) 
    --PRINT CHAR(13) + CHAR(10) 

    --Print Delete Statement
    PRINT N'/****** Object:  StoredProcedure [dbo].[' + @ProcName + 'Delete]    Script Date: ' + CAST(GETDATE() AS nvarchar(30)) + '  ******/' + CHAR(13) + CHAR(10) 
    PRINT @LEGEND;
    PRINT N'-- Description : Delete ' + @DESC + CHAR(13) + CHAR(10) 
    PRINT N'-- ===================================================================' + CHAR(13) + CHAR(10) 
    PRINT CHAR(13) + CHAR(10) 
    PRINT N'CREATE PROCEDURE [dbo].[' + @ProcName  + 'Delete]' + CHAR(13) + CHAR(10);
    PRINT N'  (@ID uniqueidentifier, @RowVersion int)' + CHAR(13) + CHAR(10);
    PRINT N'AS' + CHAR(13) + CHAR(10) 
    PRINT N'BEGIN' + CHAR(13) + CHAR(10) 
    --PRINT N'  SET CONTEXT_INFO @MyID;' + CHAR(13) + CHAR(10) 
    PRINT N'  SET NOCOUNT ON;' + CHAR(13) + CHAR(10) 
...
----Now add GRANT and DENY permissions to the Role
    --PRINT N'GRANT EXECUTE ON [dbo].[' + @ProcName + 'Delete] TO [' + @DBRoleName + ']' + CHAR(13) + CHAR(10) 
    --PRINT N'GO' + CHAR(13) + CHAR(10) 
    --PRINT N'DENY VIEW DEFINITION ON [dbo].[' + @ProcName +'Delete] TO [' + @DBRoleName + ']' + CHAR(13) + CHAR(10) 
    --PRINT N'GO' + CHAR(13) + CHAR(10) 